...
export default function IrelandUniversities() {
  ...
  return (
    <div className="my-16 text-center animate-fade-in">
      <h2 className="text-3xl font-bold mb-4 text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:from-purple-600 hover:to-blue-600 transition-all duration-500">Our Partner Universities in Ireland</h2>
        ...
        {irelandLogos.map((logo, index) => (
          ...
          >
            <div className="h-24 flex items-center justify-center">
              <Image
                src={`/logos/ireand/${encodeURIComponent(logo)}`}
