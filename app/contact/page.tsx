            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200 space-y-6">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <a href={`mailto:${SITE_CONFIG.email}`} className="text-blue-600 hover:text-blue-800 hover:underline transition-colors duration-300">{SITE_CONFIG.email}</a>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <a href="tel:+918374779361" className="text-blue-600 hover:text-blue-800 hover:underline transition-colors duration-300">{SITE_CONFIG.phone1}</a>
                  <br />
                  <a href="tel:+919704879361" className="text-blue-600 hover:text-blue-800 hover:underline transition-colors duration-300">{SITE_CONFIG.phone2}</a>
                </div>
              </div>
            </div>
          </div>
