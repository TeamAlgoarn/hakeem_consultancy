...
//         style={{ backgroundImage: "url('/Switzerland.jpg')" }}
//       >
//         <div className=" bg-opacity-80 p-6 sm:p-10 text-white max-w-xl rounded mx-4 sm:mx-10 md:ml-20" style={{marginInline:'500px'}}>
//           <h1 className="text-3xl sm:text-4xl font-bold mb-3" style={{marginInline:'-3px'}}>
//             Study abroad in <span className="text-red-600">Switzerland</span>
//           </h1>
...
//         {/* Left Content */}
//         <div>
//           <h2 className="text-2xl font-bold mb-4">Why Study in Switzerland?</h2>
          // <p className="mb-4">
          //   Switzerland is recognized as a land of ideas, known for its world-class education and technological prowess. Switzerland is the ideal destination drawing international students for excellent academics.
          // </p>
          // <p className="mb-4">
          //   When you choose to study abroad in Switzerland, you will study in universities that boast highly acclaimed international degrees.
          // </p>
          // <p className="mb-4">
          //   Thousands of students travel to Switzerland annually to seek education in some of the world’s best academies of higher learning.
          // </p>
          // <p className="mb-4">
          //   Education in Switzerland for Indian students has proven to be highly beneficial. Indian students who study in Switzerland join an international community of high achievers.
          // </p>
          // <p className="mb-4">
          //   Switzerland offers numerous benefits for students:
          // </p>
          ...
          //   <li>Switzerland Alumni Programme</li>
...
//             Book Free Consultation to Study in Switzerland
//           </h3>
    ...
    <div className="bg-white">
      ...
      >
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            Study abroad in <span className="text-blue-300">Switzerland</span>
          </h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <h2 className="text-2xl font-bold mb-4 text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:from-purple-600 hover:to-blue-600 transition-all duration-500">Why Study in Switzerland?</h2>
