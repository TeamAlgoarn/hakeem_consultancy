  ...
  return (
    <div className="bg-white">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('/ita-visa.jpg')" }}
      >
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            Italy <span className="text-blue-300">Student Visa</span>
          </h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  { title: "University Pre-enrollment", desc: "Required for degree programs" },
            ...
            >
              ...
              <div className="overflow-hidden rounded-lg shadow-md">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2783328.493416918!2d12.674866!3d42.504154!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12d4fe82448dd203%3A0xe22cf55c24635e6f!2sItaly!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin" 
                  width="100%" 
                  height="400" 
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <p className="mt-4 text-gray-600">
                Italy is located in Southern Europe, consisting of a peninsula delimited by the Alps and several islands, bordered by France, Switzerland, Austria, and Slovenia.
              </p>
            </motion.div>
          </div>
          ...
          <div className="max-w-md mx-auto relative z-10">
            <div className="bg-gradient-to-b from-blue-600 to-purple-600 text-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-blue-100 mb-6">Fill out the form below and our Italy experts will contact you shortly</p>
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-700 mb-6">
                We offer end-to-end expert guidance and services to help you achieve your study abroad goals in Italy with ease.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
