...
// // //             Study abroad in <span className="text-blue-300">Denmark</span>
// // //           </h1>
// // //           <motion.p 
// // //             initial={{ opacity: 0 }}
// // //             animate={{ opacity: 1 }}
...
// // //           >
// // //             <h2 className="text-2xl font-bold mb-4 text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:from-purple-600 hover:to-blue-600 transition-all duration-500">Why Study in Denmark?</h2>
...
// // //                   "Visa Counseling & Interview Training",
...
export default function VisaTipsDenmark() {
  ...
  return (
    ...
    <div className="bg-white">
      ...
      <div
        className="relative w-full h-[300px] sm:h-[400px] md:h-[450px] bg-cover bg-center flex items-center justify-center px-4 sm:px-8"
        style={{ backgroundImage: "url('/dubai.jpg')" }} // <-- replace with your image
      >
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="relative z-10 bg-black/60 text-white p-6 sm:p-10 rounded-lg max-w-2xl w-full text-center"
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            Study abroad in <span className="text-blue-300">Dubai</span>
          </h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            ...
            className="mb-4 text-base sm:text-lg"
          >
            Your comprehensive guide to studying in one of the world’s most dynamic,
            safe, and globally connected cities.
          </motion.p>
        </motion.div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                Dubai is a fast-growing global education hub offering world-class
                campuses, innovation-driven learning, and a multicultural lifestyle.
                Degrees are globally recognized and many programs are taught in
                English across disciplines like business, technology, design, and
                hospitality.
              </p>
              <p>
                For Indian students, Dubai is especially attractive due to geographic
                proximity, cultural diversity, strong industry links, and excellent
                internship and employment opportunities.
              </p>
              <p>Dubai offers numerous benefits for students:</p>

              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-6">
                {[
                  'Globally recognized degrees',
                  'Safe, modern, and connected city',
                  'Multicultural campus experience',
                  'English-taught programs',
                  'Industry-linked internships',
                  'Strong job market in the region',
                  'Option to work part-time while studying',
                  'Pathways to careers in the Middle East & beyond',
                ].map((item, index) => (
                  <motion.li
                    key={index}
                    whileHover={{ scale: 1.02 }}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="flex justify-center">
              ...
              >
                <Image
                  src="/du-stu.jpg" // <-- replace with your image
                  alt="UAE Flag - Study in Dubai"
                  width={600}
                  height={400}
                  className="w-full max-w-xs sm:max-w-md transition-transform duration-500 hover:scale-105"
                />
            ...
            <div>
              ...
              <p className="text-gray-700 mb-6">
                We offer end-to-end expert guidance and services to help you achieve
                your study abroad goals with ease.
              </p>
...
// /* ⬇️ Google Rating chip from your navbar block */
// const GoogleRatingComponent: React.FC = () => {
//   const handleGoogleClick = () => {
//     window.open('https://share.google/sgZIfNjCMD2PZyENv', '_blank');
//   };
...
// export default function VisaTipsDenmark() {
//   // ⬇️ state for navbar mobile menu
//   const [menuOpen, setMenuOpen] = useState(false);
...
//             {/* Form */}
//             <div className="max-w-md mx-auto relative z-10" id="form">{/* ⬅️ added id so CTA jumps here */}
