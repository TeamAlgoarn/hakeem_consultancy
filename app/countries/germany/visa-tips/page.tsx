  ...
  return (
    <div className="bg-white">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('/visa.jpg')" }}
      >
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="mt-4 text-gray-600">
                Germany is located in Central Europe, bordered by Denmark to the north, Poland and Czech Republic to the east, Austria and Switzerland to the south, and France, Luxembourg, Belgium, and Netherlands to the west.
              </p>
            </div>
          </div>
