      ...
      <section className="bg-[#f3f3f3] py-10 px-4 mt-20">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div className="bg-white p-6 md:p-10 rounded-lg shadow-md max-w-2xl">
            ...
            <p className="text-gray-700">
              Hakeem Consulting Services is a trusted <span className="text-red-600 font-medium">Ireland study visa consultant in Bangalore</span> and Chennai, India. Start your Irish education journey with us today.
            </p>
          </div>
