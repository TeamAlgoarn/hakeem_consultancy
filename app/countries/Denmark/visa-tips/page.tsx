  ...
  return (
    <div className="bg-white">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('/den-visa.jpg')" }}
      >
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            Denmark <span className="text-blue-300">Student Visa</span>
          </h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            >
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Denmark Student Visa Tips
              </h2>
              <p className="mb-4 text-gray-700">
                Denmark offers world-class education, diverse culture, and a welcoming environment for international students. Here are some visa-related tips and benefits to keep in mind.
              </p>
              ...
              <div className="mt-6">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    "Proof of financial means (DKK 6,397/month)",
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { title: "Higher Education Visa", desc: "For university degree programs" },
                  { title: "Exchange Student Visa", desc: "For exchange programs" },
                  { title: "Vocational Training Visa", desc: "For vocational courses" },
                  { title: "PhD/Research Visa", desc: "For doctoral studies" }
                ].map((item, index) => (
                  <motion.div
                    key={index}
                    whileHover={{ y: -5 }}
            ...
            >
              ...
              <div className="overflow-hidden rounded-lg shadow-md">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2257240.2743809706!2d10.02896!3d55.990258!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x464b27b6ee945ffb%3A0x528743d0c3e092cd!2sDenmark!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin" 
                  width="100%" 
                  height="400" 
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <p className="mt-4 text-gray-600">
                Denmark is located in Northern Europe, consisting of the Jutland peninsula and numerous islands, bordered by Germany to the south.
              </p>
            </motion.div>
          </div>
          ...
          <div className="max-w-md mx-auto relative z-10">
            <div className="bg-gradient-to-b from-blue-600 to-purple-600 text-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-blue-100 mb-6">Fill out the form below and our Denmark experts will contact you shortly</p>
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-700 mb-6">
                We offer end-to-end expert guidance and services to help you achieve your study abroad goals in Denmark with ease.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
