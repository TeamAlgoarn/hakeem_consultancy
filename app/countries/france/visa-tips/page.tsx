...
export default function VisaTipsFrance() {
  ...
  return (
    <div className="bg-white">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('/fra.jpg')" }}
      >
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            France Student <span className="text-blue-300">Visa Guide</span>
          </h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Everything you need to know before applying for your French student visa
          </motion.p>
        </motion.div>
      </div>
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            >
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                France Student Visa Tips
              </h2>
              <p className="mb-4 text-gray-700">
                France offers world-class education, diverse culture, and a welcoming environment for international students. Here are some visa-related tips and benefits to keep in mind.
              </p>

              <div className="mt-8">
                <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                  Why Apply for a France Tourist Visa?
                </h2>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    "University Visits & Campus Tours",
                    "See French landmarks and culture",
                    "Drive through scenic French countryside",
                    "Attend Education Fairs or Conferences",
                    "Attend 5,000+ events yearly",
                    "Attend Short-Term Courses or Workshops",
                    "Enjoy views of famous French attractions"
                  ].map((item, index) => (
                    <motion.li 
                      key={index}
              ...
              <div className="mt-8">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    "Stay up to 6 months",
                    "Travel freely across France",
                    "Bring dependents or children",
                    "Attend short-term programs",
                    "Understand France's education and job system",
                    "Qualify for in-France study permits"
                  ].map((item, index) => (
                    <motion.li 
                      key={index}
                      whileHover={{ scale: 1.02 }}
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="overflow-hidden rounded-lg shadow-md">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2624096.8466079524!2d2.213749!3d46.227638!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd54a02933785731f%3A0x6bfd3f96c747d9f7!2sFrance!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin" 
                  width="100%" 
                  height="400" 
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <p className="mt-4 text-gray-600">
                France is located in Western Europe, bordered by Belgium, Luxembourg, Germany, Switzerland, Italy, Spain, and the Atlantic Ocean, English Channel, and Mediterranean Sea.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-700 mb-6">
                Hakeem Consulting Services is a trusted <span className="text-blue-600 font-medium">FRANCE study visa consultant in Hyderabad</span>
              </p>
