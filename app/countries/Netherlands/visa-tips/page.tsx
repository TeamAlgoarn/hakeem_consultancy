...
export default function VisaTipsNetherlands() {
  ...
  return (
    <div className="bg-white">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('/nor-visa.jpg')" }}
      >
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            Netherlands <span className="text-blue-300">Student Visa</span>
          </h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            >
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Netherlands Student Visa Tips
              </h2>
              <p className="mb-4 text-gray-700">
                Netherlands offers world-class education, diverse culture, and a welcoming environment for international students. Here are some visa-related tips and benefits to keep in mind.
              </p>

              <div className="mt-6">
                <h3 className="text-xl font-semibold mb-3 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                  Why Apply for a Netherlands Tourist Visa?
                </h3>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    "University Visits & Campus Tours",
                    "See Windmills and Tulip Fields",
                    "Explore Historic Amsterdam Canals",
                    "Attend Education Fairs or Conferences",
                    "Attend 5,000+ events yearly",
                    "Short-Term Courses or Workshops",
                    "Experience Dutch Art & Culture",
            ...
            >
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Types of Netherlands Tourist Visa
              </h2>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  "Understand Netherlands's education system",
                  "Qualify for in-Netherlands study permits",
                  "Experience Dutch lifestyle"
                ].map((item, index) => (
                  <motion.div
                    key={index}
                    whileHover={{ scale: 1.02 }}
            ...
            >
              <div className="overflow-hidden rounded-lg shadow-md">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1196815.1464065253!2d4.382001!3d52.154901!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c609c3db87e4bb%3A0xb3a175ceffbd0a9f!2sNetherlands!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin" 
                  width="100%" 
                  height="400" 
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <p className="mt-4 text-gray-600">
                Netherlands is a beautiful Western European country known for its flat landscape, canals, tulip fields, and rich cultural heritage.
              </p>
            </motion.div>
          </div>
          ...
          <div className="max-w-md mx-auto relative z-10">
            <div className="bg-gradient-to-b from-blue-600 to-purple-600 text-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-blue-100 mb-6">Fill out the form below and our Netherlands experts will contact you shortly</p>
          ...
          >
            ...
            <div>
              <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 bg-clip-text text-transparent">
                Overseas Education Consultants for Netherlands
              </h2>
              ...
              <p className="text-gray-700 mb-6">
                Hakeem Consulting Services is a trusted <span className="font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">NETHERLANDS study visa consultant in Hyderabad</span>
              </p>
              ...
              >
                <Link href="#form">
                  <button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-3 rounded-lg font-semibold shadow-md hover:shadow-lg transition-all">
                    Get Free Netherlands Consultation
                  </button>
                </Link>
              </motion.div>
            </div>
