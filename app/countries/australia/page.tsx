...
//             <h2 className="text-2xl font-bold mb-4 text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:from-purple-600 hover:to-blue-600 transition-all duration-500">Why Study in Australia?</h2>
//             <div className="space-y-4 text-gray-700">
//               <p>Australia is consistently voted one of the best places to live, with a vibrant mix of cultures and a welcoming atmosphere.</p>
//               <p>It's the third most popular destination for overseas education, known for its safety, inclusivity, and support for international students.</p>
//               <p>With over 1,000 academic institutions, Australia's education system offers value, top-tier research, and post-study work rights.</p>
//               <p>Students enjoy affordable tuition, multicultural campuses, and work opportunities.</p>
