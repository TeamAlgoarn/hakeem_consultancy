      ...
      <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 px-4 sm:px-6 py-12">
        ...
        <div className="md:col-span-2 text-gray-800 space-y-8">
          <div>
            ...
            <h2 className="text-3xl font-bold mb-4">Why Apply for a Canada Tourist Visa?</h2>
            <ul className="list-disc pl-5 space-y-2 text-sm">
              <li>Visit 48 parks including Banff and Jasper</li>
              <li>See Niagara Falls and Northern Lights</li>
              <li>Drive 4,860 miles on the Trans-Canada Highway</li>
            ...
            <div className="mt-8">
              ...
              <ul className="list-disc pl-5 text-sm space-y-2">
                ...
                <li>Travel freely across Canada</li>
                <li>Bring dependents or children</li>
                <li>Attend short-term programs</li>
                <li>Understand Canada’s education and job system</li>
                <li>Qualify for in-Canada study permits</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gray-100 py-10 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="bg-white p-6 sm:p-10 rounded-lg shadow-md w-full">
            ...
            <p className="text-gray-700">
             Hakeem Consulting Services is a trusted <span className="text-red-600 font-medium">CANADA study visa consultant in Hyderbad</span> 
            </p>
          </div>
