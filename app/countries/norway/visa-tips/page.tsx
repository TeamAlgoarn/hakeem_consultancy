...
export default function VisaTipsNorway() {
      ...
      >
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            Norway <span className="text-blue-300">Student Visa</span>
          </h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            >
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Norway Student Visa Tips
              </h2>
              <p className="mb-4 text-gray-700">
                Norway offers world-class education, diverse culture, and a welcoming environment for international students. Here are some visa-related tips and benefits to keep in mind.
              </p>

              <div className="mt-6">
                <h3 className="text-xl font-semibold mb-3 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                  Why Apply for a Norway Tourist Visa?
                </h3>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    "University Visits & Campus Tours",
                    "See Northern Lights & Midnight Sun",
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  "Understand Norway's education system",
                  "Qualify for in-Norway study permits",
                  "Experience Norwegian lifestyle"
                ].map((item, index) => (
                  <motion.div
                    key={index}
                    whileHover={{ scale: 1.02 }}
            ...
            >
              <div className="overflow-hidden rounded-lg shadow-md">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2254009.4905181676!2d8.5!3d64.5!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x461268458f4de5bf%3A0xa1b03b9db864d02b!2sNorway!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin" 
                  width="100%" 
                  height="400" 
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <p className="mt-4 text-gray-600">
                Norway is a beautiful Scandinavian country known for its dramatic fjords, Northern Lights, and high quality of life.
              </p>
            </motion.div>
          </div>
          ...
          <div className="max-w-md mx-auto relative z-10">
            <div className="bg-gradient-to-b from-blue-600 to-purple-600 text-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-blue-100 mb-6">Fill out the form below and our Norway experts will contact you shortly</p>
          ...
          >
            ...
            <div>
              <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 bg-clip-text text-transparent">
                Overseas Education Consultants for Norway
              </h2>
              ...
              <p className="text-gray-700 mb-6">
                Hakeem Consulting Services is a trusted <span className="font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">NORWAY study visa consultant in Hyderabad</span>
              </p>
