    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 px-4 sm:px-6 py-12">
        ...
        <div className="md:col-span-2 text-gray-800 space-y-8">
          <div>
            <h2 className="text-2xl font-bold mb-4"> Norway Student Visa Tips</h2>
            <p className="mb-4">
            ...
            <h2 className="text-3xl font-bold mb-4">Why Apply for a Norway Tourist Visa?</h2>
            <ul className="list-disc pl-5 space-y-2 text-sm">
              <li>University Visits & Campus Tours</li>
              <li>See Niagara Falls and Northern Lights</li>
              <li>Drive 4,860 miles on the Trans-NorwayHighway</li>
            ...
            <div className="mt-8">
              <h2 className="text-2xl font-semibold mb-3">Types of Norway Tourist Visa</h2>
              <p className="mb-2">
            ...
            <div className="mt-8">
              ...
              <ul className="list-disc pl-5 text-sm space-y-2">
                ...
                <li>Understand Norway’s education and job system</li>
                <li>Qualify for in-Norway study permits</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="bg-white p-6 sm:p-10 rounded-lg shadow-md w-full">
            ...
            <p className="text-gray-700">
              Hakeem Consulting Services is a trusted <span className="text-red-600 font-medium">Norway study visa consultant in Bangalore</span> and Chennai. Book a consultation today.
            </p>
          </div>
