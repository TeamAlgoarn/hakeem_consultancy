...
export default function VisaTipsLuxembourg() {
  ...
  return (
    <div className="bg-white">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('/lux-visa.jpg')" }}
      >
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            Luxembourg <span className="text-blue-300">Student Visa</span>
          </h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            >
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Luxembourg Student Visa Tips
              </h2>
              <p className="mb-4 text-gray-700">
                Luxembourg offers world-class education, diverse culture, and a welcoming environment for international students. Here are some visa-related tips and benefits to keep in mind.
              </p>
            ...
            >
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Types of Luxembourg Student Visas
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { title: "Type D Visa", desc: "For long-term university studies" },
                  { title: "Short-stay Visa", desc: "For courses under 90 days" },
                  { title: "Exchange Visa", desc: "For student exchange programs" },
                  { title: "Research Visa", desc: "For PhD candidates and researchers" }
                ].map((item, index) => (
                  <motion.div
                    key={index}
                    whileHover={{ y: -5 }}
            ...
            >
              ...
              <div className="overflow-hidden rounded-lg shadow-md">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1039189.716365041!2d5.674137!3d49.815273!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479545b9f690dafd%3A0xe9dbefd035d5ea27!2sLuxembourg!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin" 
                  width="100%" 
                  height="400" 
                  style={{ border: 0 }}
                  allowFullScreen
          ...
          <div className="max-w-md mx-auto relative z-10">
            <div className="bg-gradient-to-b from-blue-600 to-purple-600 text-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-blue-100 mb-6">Fill out the form below and our Luxembourg experts will contact you shortly</p>
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-700 mb-6">
                We offer end-to-end expert guidance and services to help you achieve your study abroad goals in Luxembourg with ease.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
              ...
              >
                <Link href="#form">
                  <button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-3 rounded-lg font-semibold shadow-md hover:shadow-lg transition-all">
                    Get Free Luxembourg Consultation
                  </button>
                </Link>
              </motion.div>
            </div>
