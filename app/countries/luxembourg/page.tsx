...
//             Study abroad in <span className="text-red-600">Luxembourg</span>
//           </h1>
...
//         {/* Left Content */}
//         <div>
//           <h2 className="text-2xl font-bold mb-4">Why Study in Luxembourg?</h2>
          // <p className="mb-4">
          //   Luxembourg is recognized as a land of ideas, known for its world-class education and technological prowess. Luxembourg is the ideal destination drawing international students for excellent academics.
          // </p>
          // <p className="mb-4">
          //   When you choose to study abroad in Luxembourg, you will study in universities that boast highly acclaimed international degrees.
          // </p>
          // <p className="mb-4">
          //   Thousands of students travel to Luxembourg annually to seek education in some of the world’s best academies of higher learning.
          // </p>
          // <p className="mb-4">
          //   Education in Luxembourg for Indian students has proven to be highly beneficial. Indian students who study in Luxembourg join an international community of high achievers.
          // </p>
          // <p className="mb-4">
          //   Luxembourg offers numerous benefits for students:
          // </p>
...
//             Book Free Consultation to Study in Luxembourg
//           </h3>
  ...
  return (
    <div className="bg-white">
      ...
      >
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            Study abroad in <span className="text-blue-300">Luxembourg</span>
          </h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <h2 className="text-2xl font-bold mb-4 text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:from-purple-600 hover:to-blue-600 transition-all duration-500">Why Study in Luxembourg?</h2>
